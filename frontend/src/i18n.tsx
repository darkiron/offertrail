...
const translations = {
  fr: {
    ...
    backlog: {
      kicker: 'Radar opportunites',
      title: 'Backlog jobs',
      copy: 'Rassembler des annonces, les scorer, puis convertir les plus pertinentes en candidatures INTERESTED.',
      createSearch: 'Creer une recherche',
      sourceType: 'Source',
      sourceMock: 'Mock board',
      sourceWwr: 'We Work Remotely RSS',
      feedKey: 'Flux',
      runSearch: 'Lancer',
      noSearches: 'Aucune recherche definie pour le moment.',
      noItems: 'Aucune annonce dans le backlog pour cette recherche.',
      importItem: 'Importer en interested',
      imported: 'Importe',
      keywords: 'Mots-cles',
      excluded: 'Exclusions',
      locations: 'Lieux',
      ...
      reasons: 'Raisons',
      status: 'Statut',
      createError: 'Impossible de creer la recherche.',
      loadError: 'Impossible de charger le backlog.',
    },
  },
} as const;
