...
export function LandingLayout() {
  ...
  return <div className={classes.root} data-theme={dark ? 'dark' : 'light'}>
    ...
    {mobileMenuOpen&&<div id="public-mobile-menu" className={classes.mobileMenu}><a href="/#features" className={classes.navLink} onClick={closeMenu}>{t('landing.nav.features')}</a><a href="/#workflow" className={classes.navLink} onClick={closeMenu}>{t('landing.nav.workflow')}</a><a href="/#tarifs" className={classes.navLink} onClick={closeMenu}>{t('landing.nav.pricing')}</a><a href="/#faq" className={classes.navLink} onClick={closeMenu}>{t('landing.nav.faq')}</a><Link to="/login" className={classes.btnOutline} onClick={closeMenu}>{t('landing.nav.login')}</Link><Link to="/register" className={classes.btnPrimary} onClick={closeMenu}>{t('landing.nav.cta')}</Link><LanguageSwitcher /></div>}
