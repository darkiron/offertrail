...
export const ContactPage: React.FC = () => {
  ...
  React.useEffect(() => {
    document.title = t('nav.contact') + ' — OfferTrail';
  }, [t]);
  ...
  return (
    ...
    >
      ...
      <div className="contact-cards">
        ...
        <div className="contact-info-card">
          <div className="contact-info-card-icon">⏱️</div>
          <h3>{t('contactPage.delayTitle')}</h3>
          <p>{t('contactPage.delayText')}</p>
        </div>
      </div>
          ...
          <form className="contact-form" onSubmit={handleSubmit}>
            <div className="contact-row">
              <div className="contact-field">
                <label className="contact-label">{t('contactPage.nameLabel')}</label>
                <input
              ...
              <div className="contact-field">
                <label className="contact-label">{t('contacts.email')}</label>
                <input
                  className="contact-input"
                  type="email"
            ...
            <div className="contact-field">
              <label className="contact-label">{t('contactPage.subjectLabel')}</label>
              <input
                className="contact-input"
                type="text"
            ...
            <div className="contact-field">
              <label className="contact-label">{t('contactPage.messageLabel')}</label>
              <textarea
            ...
            <button className="contact-submit" type="submit" disabled={loading}>
              {loading ? t('contactPage.sending') : t('contactPage.submitAction')}
            </button>
          </form>
        )}
      </div>
