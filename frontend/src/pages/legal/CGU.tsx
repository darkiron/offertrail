...
const CGUFR: React.FC = () => (
  <>
    ...
    <div className="legal-section"><h2>Article 3 — Description du service</h2><p>OfferTrail permet de gérer un pipeline de candidatures, de suivre les entreprises et contacts, de planifier des relances et de visualiser des statistiques de recherche d'emploi.</p><p>Le service propose un plan Free et deux abonnements payants, Pro et Ultimate, avec les limites et prix affichés sur la page Tarifs.</p></div>
...
const CGUEN: React.FC = () => (
  <>
    ...
    <div className="legal-section"><h2>Article 3 — Service description</h2><p>OfferTrail lets you manage an application pipeline, track companies and contacts, schedule follow-ups and view job-search statistics.</p><p>The service offers a Free plan and two paid subscriptions, Pro and Ultimate, with limits and prices shown on the Pricing page.</p></div>
